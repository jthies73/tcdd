...
Rails.application.configure do
  ...
  # TODO: Update with your staging domain
  config.action_mailer.default_url_options = { host: ENV.fetch("STAGING_HOST", "staging.example.com") }

  # Set default URL options for ActionCable broadcasts and other URL generation
  # TODO: Replace with your actual staging domain
  Rails.application.routes.default_url_options = { host: ENV.fetch("STAGING_HOST", "staging.trashcan-dresden.yafa.app") }
